...
BOARDFAMILY="beaglev-ahead"
BOOTCONFIG="linux-beaglev-ahead" # vendor name, not standard, see hook below, set BOOT_SOC below to compensate
BOOT_SOC="c910"
KERNEL_TARGET=" "
FULL_DESKTOP="yes"
BOOT_LOGO="desktop"
BOOT_FDT_FILE="th1520-beaglev-ahead.dtb"
BOOT_SCENARIO="spl-blobs"
WIREGUARD="no"
BOOT_SUPPORT_SPI="yes"
IMAGE_PARTITION_TABLE="gpt"
SKIP_BOOTSPLASH="no" # Skip boot splash patch, conflicts with CONFIG_VT=yes
SRC_EXTLINUX="yes"     # going back to standard uboot for now
ROOTFS_TYPE="ext4"
